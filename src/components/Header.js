    ...
    <div className="shadow-sm fixed bg-white w-full z-20">
      ...
      <div className="container-box flex justify-between items-center"> 
        ...
        <div className="navLinks flex ">
          <ul className="flex">
            <Link to={"/"}><li className="px-3 py-1 mx-4 cursor-pointer active:outline-none border-b-2 border-transparent active:border-b-2  active:border-blue-700"><p className="text-blue-700 text-lg font-semibold" >Home</p></li></Link>
