  ...
  return (
    <div className="grid content-center h-screen mx-auto  align-middle w-6/12 ">
        ...
        <div className="text-center font-semibold text-md my-2 py-2 relative">
          <button onClick={() => navigate('/')} className="bg-blue-700 text-white px-4 pl-7 py-1 rounded ">Continue Shopping<span><MdArrowRightAlt className="inline-block  text-3xl px-1" /></span></button>
        </div>
      </div>
  )
}
